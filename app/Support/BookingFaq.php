    ...
    public static function all(): array
    {
        return [
            ...
            [
                ...
                'a' => "Les accompagnements à distance se font de plus en plus. Certains praticiens ou thérapeutes arrivent même à utiliser l'hypnose à distance, par exemple. Donc, hormis cas particuliers ou une séance en présentiel doit obligatoirement se faire (comme aller se promener avec son praticien ou thérapeute dans le cadre d'un exercice pour lutter contre la timidité), l'accompagnement à distance vaut autant qu'un accompagnement en présentiel. Vous évitez de prendre la voiture, vous restez chez vous dans votre confort, et surtout : vous pouvez joindre votre praticien où que vous vous trouviez dans le monde ! Certaines personnes, réticentes à aller confier leurs soucis anxieux à un praticien, éprouvent moins de difficultés à le faire à distance.",
            ],
            [
                'q' => 'Est-ce que tout ce que je dis restera confidentiel ?',
                'a' => "Bien évidemment ! Je comprends que vous souhaitiez que les informations que vous me communiquerez restent confidentielles. Je m'engage à respecter votre vie privée à 100 %. Je ne divulguerai donc aucune information à votre sujet à qui que ce soit. N'oubliez pas que j'ai également souffert de troubles anxieux. Je respecte ainsi tout à fait votre besoin de confidentialité.",
            ],
            [
                'q' => 'Quelle crédibilité avez-vous pour proposer des accompagnements à des personnes souffrant de troubles anxieux ? Vous n\'êtes pas docteur, ni psychologue.',
                'a' => "Je suis praticienne ACT, laquelle est une approche thérapeutique dont l'efficacité est validée scientifiquement. Elle fait partie des TCC de 3ᵉ vague, qui enrichissent les thérapies cognitives et comportementales classiques. De plus, j'estime que personne ne peut en comprendre une autre sans avoir expérimenté la même chose. Je connais très bien ce trouble, puisque je l'ai vécu. Et surtout, je m'en suis sortie. Je suis également la première à encourager les personnes venant me consulter à aller voir un psychologue, un médecin ou un psychiatre s'ils en ressentent le besoin.",
            ],
        ];
    }
}
