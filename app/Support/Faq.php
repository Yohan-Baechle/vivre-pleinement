...
/**
 * Questions fréquentes générales du site, partagées entre la page FAQ dédiée
 * et l'aperçu affiché sur la page d'accueil.
 */
class Faq
{
    /**
    ...
    public static function all(): array
    {
        return [
            ...
            [
                ...
                'a' => "Une séance individuelle d'une heure est à 50 €. Vous réservez à l'unité, sans forfait imposé, pour avancer à votre rythme. Les séances ne sont pas remboursées par la Sécurité sociale, mais certaines mutuelles prennent en charge ce type d'accompagnement au titre du bien-être : pensez à vous renseigner auprès de la vôtre.",
            ],
            [
