...
class ApplySeoTitles extends Command
{
    ...
    private function titles(): array
    {
        return [
            ...
            'comment-soigner-la-blessure-de-trahison-11-conseils-precieux' => 'Comment soigner la blessure de trahison : 11 conseils',
            'blessure-de-rejet-9-symptomes-pour-la-reconnaitre' => 'Blessure de rejet : 9 symptômes pour la reconnaître',
            ...
            'la-phobie-dimpulsion-une-peur-ou-une-envie' => "Phobie d'impulsion : une peur ou une envie ?",
            'comment-soigner-la-thanatophobie-peur-de-la-mort' => 'Thanatophobie : comment soigner la peur de la mort',
            'reconnaitre-la-blessure-de-trahison-en-9-symptomes' => 'Blessure de trahison : 9 symptômes pour la reconnaître',
            'toc-et-pensees-intrusives-les-comprendre-et-sen-liberer' => "TOC et pensées intrusives : comprendre et s'en libérer",
            ...
            'blessure-dinjustice-comment-la-soigner-8-facons-dy-parvenir' => "Blessure d'injustice : comment la soigner (8 façons)",
            'comment-vaincre-la-cardiophobie-peur-de-faire-une-crise-cardiaque' => 'Cardiophobie : vaincre la peur de la crise cardiaque',
            'comment-soigner-la-blessure-de-rejet-8-conseils-utiles' => 'Comment soigner la blessure de rejet : 8 conseils utiles',
            'ergophobie-peur-du-travail-comment-sen-sortir' => "Ergophobie (peur du travail) : comment s'en sortir",
            ...
            'blessure-dinjustice-11-symptomes-qui-la-caracterisent' => "Blessure d'injustice : 11 symptômes qui la caractérisent",
            ...
            'guerir-dun-trouble-anxieux-generalise-tag-cest-possible' => "Guérir d'un trouble anxieux généralisé (TAG), c'est possible",
            'blessure-dabandon-9-symptomes-pour-la-reconnaitre' => "Blessure d'abandon : 9 symptômes pour la reconnaître",
            ...
            'stress-anxiete-ou-angoisse-les-differences-a-comprendre-pour-guerir' => 'Stress, anxiété ou angoisse : quelles différences ?',
            ...
            'comprendre-les-addictions-pour-sen-liberer' => "Comprendre les addictions pour s'en libérer",
