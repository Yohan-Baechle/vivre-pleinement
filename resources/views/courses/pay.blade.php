    ...
    <main class="bg-cream-50 pt-32 pb-20 sm:pt-36">
        <div class="mx-auto max-w-xl px-4 sm:px-6">
            ...
            <form id="payment-form"
                  ...
                  data-return-url="{{ route('courses.checkout.success', $course) }}">
                ...
                <label class="mt-5 flex items-start gap-3">
                    ...
                    <span class="text-ink-soft text-xs">
                        Je demande l'accès immédiat à la formation et reconnais renoncer expressément à mon droit de rétractation de 14 jours dès la mise à disposition du contenu numérique.
                    </span>
                </label>
